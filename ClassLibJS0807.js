'use strict';
// Этот класс отвечает только за валидацию данных
class Validator {
...
class Controller {
    ...
    activateListeners() {
        ...
        this.pass1.addEventListener('blur', () => {
            this.validator.checkPass1(this.pass1.value);
        });
        this.pass2.addEventListener('blur', () => {
            this.validator.checkPass2(this.pass2.value);
        });
